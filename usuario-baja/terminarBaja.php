...
// printf($ahora);
// var_dump($ahora);
// $sqlInsert = "INSERT INTO bajas(fecha, total) VALUES ('$ahora', $total);";
...
foreach ($_SESSION["Baja"] as $producto) {
    // $total += $producto['total'];
    $id = $producto['id'];
    $cantidad = $producto['cantidad'];
	// $sqlInsert ="INSERT INTO productos_baja(id_producto, cantidad) VALUES ($id,$cantidad);";
    // $conn->query($sqlInsert);
