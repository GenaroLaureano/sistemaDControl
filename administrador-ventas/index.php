...
if(!isset($_SESSION["adminVentas"])) $_SESSION["adminVentas"] = []; //si no existe la variable Baja la crea como un arreglo vacio
...
?>
  ...
  <div class="content">
	<div class="col-xs-12">
		<h1><i class="fas fa-shopping-basket"></i> Consultar Ventas</h1>
      ...
      <!-- <br><br> -->
		...
		?>
            ...
            <!-- </div> -->
            <!-- <div class="form-group"> -->
              <button type="submit" name="add_user" class="btn btn-primary">Consultar</button>
			  <!-- <br> -->
            <!-- </div> -->
        </form>
        </div>
		...
		<?php
			...
			if($_GET['consulta'] === "1"){
			$devoluciones = $_SESSION['adminVentas'];
